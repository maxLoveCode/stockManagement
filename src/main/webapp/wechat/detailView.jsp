...
<html ng-app="ionicApp">
	<head>
        ...
        angular.module('ionicApp', ['ionic']);
         ...
         <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jssor.js"></script>
    <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/jssor.slider.js"></script>
      ...
      <ion-scroll   style="height: 94%">
       ...
       <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 800px;
        ...
        <div id="s" u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 800px; height: 356px; overflow: hidden;">
           ...
           <div>
                <img u="image" src="${bean }" />
                <img u="thumb" src="${bean }" />
            </div>
            </c:forEach>
            <%-- <div>
                <img u="image" src="${warehouse.frontPage1}" />
                <img u="thumb" src="${warehouse.frontPage1}" />
            </div>
            <div>
                <img u="image" src="${warehouse.frontPage2}" />
                <img u="thumb" src="${warehouse.frontPage2}" />
            </div>  --%>
        </div>
        <style>
